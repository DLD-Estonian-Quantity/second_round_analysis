...
% This script is for the second time window, determined  by the ERF analysis
...
outdir = 'L:\eeg\lastekatse2021\Erik\data\working\analysis\TF_permTest_ungrouped_groupSep_stimSep_condSep_TW2';
...
for group = 1:length(groupCode)
    for stim = 1:length(stimulus)
        for cond = 1:length(condition)
            ...
            cfg.foilim                  = [3 15];
            cfg.channel                 = ft_channelselection('EEG',{'P4', 'Cp2', 'Fc2', 'Cp1'})
